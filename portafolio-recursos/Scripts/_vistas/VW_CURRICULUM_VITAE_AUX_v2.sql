  CREATE OR REPLACE FORCE VIEW "PORTAFOLIO"."VW_CURRICULUM_VITAE_AUX" ("ID_PERFIL", "NO_PERSONA", "NU_DNI_PERFIL", "TEL_PERFIL", "EMAIL_PERFIL", "DIR_PERFIL", "NO_PORTAFOLIO", "NO_SKILLSET", "TURNO", "SOBRE_MI", "RESUMEN", "DE_EDUCACION", "DE_EXPERIENCIA", "DE_FORMACION", "DE_IDIOMA", "DE_HABILIDAD", "DE_DATO") AS 
  SELECT 
